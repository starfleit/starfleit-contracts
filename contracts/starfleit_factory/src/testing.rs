...
use starfleit::mock_querier::{mock_dependencies, WasmMockQuerier};
...
fn reply_create_pair_with_provide() {
    ...
    deps.querier
        .with_balance(&[(&MOCK_CONTRACT_ADDR.to_string(), coins(100u128, "afet"))]);
    ...
    assert_eq!(
        ...
        SubMsg {
            ...
            msg: CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                .unwrap(),
                funds: coins(100u128, "afet".to_string()),
            }),
            gas_limit: None,
            reply_on: ReplyOn::Never,
        }
