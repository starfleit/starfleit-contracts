...
use starfleit::asset::{Asset, AssetInfo, PairInfo, PairInfoRaw};
use starfleit::pair::{
...
const CONTRACT_NAME: &str = "crates.io:starfleit-pair";
    ...
    Ok(Response::new().add_submessage(SubMsg {
        ...
        msg: WasmMsg::Instantiate {
            ...
            msg: to_binary(&TokenInstantiateMsg {
                name: "starfleit liquidity token".to_string(),
...
/// we compute new spread else we just use starfleit
